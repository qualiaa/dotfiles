...
fzf_ignore_list=(cluster cloud Datasets .oh-my-zsh .nv .mozilla .cache .git '.mypy*' .hg .svn .ssh '.pylint*' '.*conda3')
...
grep -Rl -- "^-----BEGIN RSA PRIVATE KEY-----$" ~/.ssh  | xargs -n1 basename | tr '\n' ' ')
